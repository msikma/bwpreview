...
const generateMapPreview = async (file, gfx, {obsSkip, imgSkip, imgType, imgSize, useInternalName, nameSuffix, outFlatten, outQuiet, pathRel, pathOut = null} = {}) => {
  ...
  logFeedback(outQuiet, pathRel ? path.relative(pathRel, target) : target, false, false, {imgType, width: imgWidth, height: imgHeight, start, size: Buffer.byteLength(buffer)})
}
